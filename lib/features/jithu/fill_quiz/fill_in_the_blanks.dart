                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'Peacock is the national bird of ___________________ .',
                        style: TextStyle(
                      ...
                      children: [
                        Expanded(
                          child: Image(
                            height: 300,
                            width: 300,
                            image: AssetImage('assets/images/boystudy.png'),
                          ),
                        ),
                        Column(
                          children: [
                            PinkButton(answer: 'India'),
                            PinkButton(answer: 'China'),
                            PinkButton(answer: 'Australia'),
                          ],
                        )
                      ],
                    )
